...
Public Class EditGunClassications
    ...
    Private Sub EditGunClassications_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GunManufacturerBindingSource_ListChanged(ByVal sender As Object, ByVal e As ListChangedEventArgs) Handles GunCollectionClassificationBindingSource.ListChanged
