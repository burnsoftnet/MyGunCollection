...
<DesignerGenerated()> _
Partial Class FrmViewReportPictures
    Inherits Form
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentResourceManager = New ComponentResourceManager(GetType(FrmViewReportPictures))
