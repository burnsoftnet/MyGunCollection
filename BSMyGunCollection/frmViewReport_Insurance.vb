...
Public Class frmViewReport_Insurance
    ...
    '    End If
    'End Sub
    Private Sub frmViewReport_Insurance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frmViewReport_Insurance_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        'Call DoResize()
    End Sub
