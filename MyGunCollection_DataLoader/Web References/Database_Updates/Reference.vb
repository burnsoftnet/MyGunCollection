...
Imports MyGunCollection_DataLoader.My
...
Namespace Database_Updates
    ...
    '''<remarks/>
    <GeneratedCode("System.Web.Services", "4.0.30319.1"),  _
     DebuggerStepThrough(),  _
     DesignerCategory("code"),  _
     WebServiceBinding(Name:="My Gun Collection Database UpdateSoap", [Namespace]:="http://www.burnsoft.net/")>  _
    Partial Public Class MyGunCollectionDatabaseUpdate
        Inherits SoapHttpClientProtocol
        
        Private IsRegisteredUserOperationCompleted As SendOrPostCallback
        
        Private Gun_ManufacturerOperationCompleted As SendOrPostCallback
        
        Private Gun_CalOperationCompleted As SendOrPostCallback
        
        Private Gun_GripTypeOperationCompleted As SendOrPostCallback
        
        Private Gun_ModelOperationCompleted As SendOrPostCallback
        
        Private Gun_NationalityOperationCompleted As SendOrPostCallback
        
        Private Gun_TypeOperationCompleted As SendOrPostCallback
        
        Private Maintance_PlansOperationCompleted As SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = MySettings.Default.MyGunCollection_DataLoader_Database_Updates_My_x0020_Gun_x0020_Collection_x0020_Database_x0020_Update
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/IsRegisteredUser", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_Manufacturer", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_Manufacturer() As DataSet
            Dim results() As Object = Me.Invoke("Gun_Manufacturer", New Object(-1) {})
            Return CType(results(0),DataSet)
        End Function
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_Cal", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_Cal() As DataSet
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_GripType", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_GripType() As DataSet
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_Model", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_Model() As DataSet
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_Nationality", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_Nationality() As DataSet
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Gun_Type", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Gun_Type() As DataSet
        ...
        '''<remarks/>
        <SoapDocumentMethod("http://www.burnsoft.net/Maintance_Plans", RequestNamespace:="http://www.burnsoft.net/", ResponseNamespace:="http://www.burnsoft.net/", Use:=SoapBindingUse.Literal, ParameterStyle:=SoapParameterStyle.Wrapped)>  _
        Public Function Maintance_Plans() As DataSet
        ...
        Private Function IsLocalFileSystemWebService(ByVal url As String) As Boolean
            ...
            If ((wsUri.Port >= 1024)  _
                        AndAlso (String.Compare(wsUri.Host, "localHost", StringComparison.OrdinalIgnoreCase) = 0)) Then
                Return true
            End If
            Return false
        End Function
    ...
    Partial Public Class Gun_ManufacturerCompletedEventArgs
        ...
        Public ReadOnly Property Result() As DataSet
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(0),DataSet)
            End Get
        End Property
    End Class
